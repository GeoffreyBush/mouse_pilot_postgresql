    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='father_breedingcage', to='website.mouse')),
                ('mother', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='mother_breedingcage', to='website.mouse')),
            ],
            options={
