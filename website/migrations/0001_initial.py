    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='father_mice', to='website.mouse')),
            ],
            options={
                'db_table': 'mice',
                'managed': True,
        ...
        migrations.AddField(
            model_name='mouse',
            name='mother',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mother_mice', to='website.mouse'),
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
