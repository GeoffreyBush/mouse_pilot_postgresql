...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Cage',
            fields=[
                ('cageID', models.AutoField(db_column='Cage ID', primary_key=True, serialize=False)),
                ('box_no', models.CharField(blank=True, db_column='Box Number', max_length=10, null=True)),
                ('status', models.CharField(choices=[('Empty', 'Empty'), ('ParentsInside', 'ParentsInside'), ('ParentsRemoved', 'ParentsRemoved')], db_column='Status', default='Empty', max_length=20)),
                ('mother', models.CharField(blank=True, db_column='Mother', max_length=20, null=True)),
                ('father', models.CharField(blank=True, db_column='Father', max_length=20, null=True)),
                ('date_born', models.DateField(db_column='DBorn')),
                ('number_born', models.CharField(blank=True, db_column='NBorn', max_length=5, null=True)),
                ('cull_to', models.CharField(blank=True, db_column='C/To', max_length=20, null=True)),
                ('date_wean', models.DateField(db_column='Dwean')),
                ('number_wean', models.CharField(blank=True, db_column='Nwean', max_length=5, null=True)),
                ('pwl', models.CharField(blank=True, db_column='PWL', max_length=5, null=True)),
            ],
            options={
                'db_table': 'cage',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cage', models.ForeignKey(blank=True, db_column='Cage ID', null=True, on_delete=django.db.models.deletion.SET_NULL, to='website.cage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cage', models.ForeignKey(blank=True, db_column='Cage ID', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='website.cage')),
