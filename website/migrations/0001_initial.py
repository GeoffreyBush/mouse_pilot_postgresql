    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coat', models.CharField(blank=True, db_column='Coat', max_length=20, null=True)),
                ('result', models.CharField(blank=True, db_column='Result', max_length=20, null=True)),
                ('fate', models.CharField(blank=True, db_column='Fate', max_length=40, null=True)),
        ...
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('comment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='website.mouse')),
        ...
        migrations.AddField(
            model_name='mouse',
            name='mother',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='mother_mouse', to='website.mouse'),
        ),
        migrations.CreateModel(
            name='BreedingCage',
            fields=[
                ...
                ('father', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='father_breeding_cage', to='website.mouse')),
                ('mother', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='mother_breeding_cage', to='website.mouse')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='mouse',
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='website.project'),
        ),
        migrations.CreateModel(
            name='Request',
            fields=[
        ...
        migrations.AddField(
            model_name='mouse',
            name='stock_cage',
            field=models.ForeignKey(blank=True, db_column='Stock Cage ID', default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mice', to='website.stockcage'),
        ),
        migrations.AddField(
            model_name='mouse',
            name='strain',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='website.strain'),
        ),
    ]
