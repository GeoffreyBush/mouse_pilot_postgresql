# Generated by Django 5.0.6 on 2024-05-25 16:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='father_mouse', to='website.mouse')),
            ],
            options={
                'db_table': 'mice',
                'managed': True,
        ...
        migrations.AddField(
            model_name='mouse',
            name='mother',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mother_mouse', to='website.mouse'),
        ),
        migrations.CreateModel(
            name='BreedingCage',
            fields=[
